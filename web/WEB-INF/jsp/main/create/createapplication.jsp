...
<div class="create-form-button-container">
    ...
    <ul>
        ...
        <li>System will create the application</li>
...
<br class="clearfix" />
<br class="clearfix" />
<form:form method="POST" action="${pageContext.request.contextPath}/home/create/application/create/" commandName="application">
    <div class="create-form-button-container">
    ...
    <div class="create-form-button-container">
        <div class="form-group">Application name:
            <form:input type="text" path="applicationName" class="form-control" placeholder="Enter application name" />
            <p class="help-block">Unique application identifier</p>
        </div>      
    </div>
