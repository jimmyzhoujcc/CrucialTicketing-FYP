...
<div class="create-form-button-container">
    <c:choose>
        <c:when test="${edit}">
            <form action="<%=request.getContextPath()%>/home/update/application/save/" method="POST">
            ...
            <c:otherwise>
                <form action="<%=request.getContextPath()%>/home/update/application/edit/" method="POST">
