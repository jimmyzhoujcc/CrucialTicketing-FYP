...
<div class="column1">
    ...
    <br />
    <ul>
        <li><a href="<%=request.getContextPath()%>/home/create/ticket/p1/">Ticket</a></li>
        <li><a href="<%=request.getContextPath()%>/home/create/user/">User</a></li>
        <li><a href="<%=request.getContextPath()%>/home/create/role/">Role</a></li>
        <li><a href="<%=request.getContextPath()%>/home/create/userrolecon/">User Role Connection</a></li>
        <li><a href="<%=request.getContextPath()%>/home/create/queue/">Queue</a></li>
        <li><a href="<%=request.getContextPath()%>/home/create/userqueuecon/">User Queue Connection</a></li>
