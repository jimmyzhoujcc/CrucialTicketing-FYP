...
public class TicketChangeLog {
    ...
    private List<TicketChangeLogEntry> changeLog;
    private int timeElapsed;

    public TicketChangeLog() {
        changeLog = new ArrayList<>();
    }

    public List<TicketChangeLogEntry> getChangeLog() {
        return changeLog;
    }

    public void setChangeLog(List<TicketChangeLogEntry> changeLog) {
    ...
    public void setTimeElapsed() {
        TicketChangeLogEntry prevChangeLogEntry;
        TicketChangeLogEntry currChangeLogEntry;
        this.timeElapsed = 0;
        boolean clockActive;
        ...
        for (TicketChangeLogEntry tempChangeLogEntry : changeLog) {
            if (i == 0) {
                i++;
            } else {
